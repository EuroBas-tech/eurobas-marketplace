...
<head>
    ...
    <link rel="stylesheet" href="{{env_asset('assets/back-end')}}/css/vendor.min.css">
    <link rel="stylesheet" href="{{env_asset('assets/back-end')}}/css/bootstrap.min.css">
    <link rel="stylesheet" href="{{env_asset('assets/back-end')}}/css/custom.css">
    ...
    <link rel="stylesheet" href="{{env_asset('assets/back-end')}}/vendor/icon-set/style.css?v=1234">
    <!-- CSS Front Template -->
    <link rel="stylesheet" href="{{env_asset('assets/back-end')}}/css/theme.minc619.css?v=1.0">
    <link rel="stylesheet" href="{{env_asset('assets/back-end')}}/css/style.css?v=1234">
    @if(Session::get('direction') === "rtl")
        <link rel="stylesheet" href="{{env_asset('assets/back-end')}}/css/menurtl.css">
    @endif
    {{-- light box --}}
    <link rel="stylesheet" href="{{env_asset('css/lightbox.css')}}">
    @stack('css_or_js')
    <!-- <style>
        :root {
            --theameColor: #045cff;
    ...
    @if(\Illuminate\Support\Facades\App::getLocale() == 'ae')
    ...
    <script
        src="{{env_asset('assets/back-end')}}/vendor/hs-navbar-vertical-aside/hs-navbar-vertical-aside-mini-cache.js"></script>
    <link rel="stylesheet" href="{{env_asset('assets/back-end')}}/css/toastr.css">
</head>
...
<script src="{{env_asset('assets/back-end')}}/js/custom.js"></script>
<!-- JS Implementing Plugins -->

{{--@stack('script')--}}

<!-- JS Front -->
<script src="{{env_asset('assets/back-end')}}/js/vendor.min.js"></script>
<script src="{{env_asset('assets/back-end')}}/js/theme.min.js"></script>
<script src="{{env_asset('assets/back-end')}}/js/sweet_alert.js"></script>
<script src="{{env_asset('assets/back-end')}}/js/toastr.js"></script>
{!! Toastr::message() !!}
