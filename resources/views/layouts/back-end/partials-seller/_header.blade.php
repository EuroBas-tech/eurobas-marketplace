                ...
                <a class="navbar-brand" href="{{route('seller.dashboard.index')}}" aria-label="">
                    @if (isset($shop))
                        <img class="navbar-brand-logo"
                             ...
                             src="{{cloudfront("shop/$shop->image")}}" alt="Logo" height="40">
                        ...
                        <div class="hs-unfold">
                            <div>
                                ...
                                <div
                                    ...
                                    <ul class="dropdown-menu" style="max-height: 550px;overflow-y: auto;" >
                               ...
                               data-hs-unfold-options='{
                                ...
                                <div class="avatar avatar-sm avatar-circle">
                                    <img class="avatar-img"
                                         onerror="this.src='{{asset('public/assets/back-end/img/160x160/img1.jpg')}}'"
                                         src="{{cloudfront('seller/')}}/{{auth('seller')->user()->image}}"
