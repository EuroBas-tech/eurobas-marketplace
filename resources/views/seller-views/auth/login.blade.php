...
<head>
    ...
    <style>
        * {
        ...
        .dashed-border {
            border: 1px dashed #0f3f7c45;
        }

        .product-card-shadow {
            box-shadow: -1px 1px 5px #80808028, 1px 1px 5px #80808028;
        }
...
<main id="content" role="main" class="main">
    <div class="position-fixed d-none top-0 right-0 left-0 bg-img-hero __h-32rem"
    ...
    <div class="container py-5 pt-3 py-sm-4">
        ...
        <div class="row justify-content-center">
            <div class="col-md-7 col-lg-5">
                <!-- Card -->
                <div class="card card-lg mb-5 product-card-shadow">
                    <div class="card-body">
                        <!-- Form -->
                        <form id="form-id"  action="{{route('seller.auth.login')}}" method="post">
                            ...
                            <div class="form-group d-flex align-items-center justify-content-between">
                                ...
                                <div class="custom-control custom-checkbox">
                                    <a class="" href="{{ route('shop.apply') }}" >
                                      {{translate('Create_an_account_as_a_seller')}}
                                    </a>
                                </div>
                            </div>
                            <!-- End Checkbox -->
                            ...
                            @endif
                            <button type="submit" style="background: #0f407d;" class="btn btn-lg btn-block btn--primary">{{translate('sign_in')}}</button>
                        </form>
                        <!-- End Form -->
                    </div>
