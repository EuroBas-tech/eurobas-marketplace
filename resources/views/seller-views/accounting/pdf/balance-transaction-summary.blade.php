...
<head>
    ...
    <title>{{ translate('summary_transaction').' - '.rand(1000, 9999) }}</title>
                ...
                <table class="bs-0">
                    <tr>
                        <th class="h3 p-0 text-left">
                            {{translate('seller_balance_summary_transaction')}}
                        </th>
                ...
                <table class="bs-0">
                    <tr>
                        ...
                        <td class="p-0 text-left">
                            <table>
                                <tr>
                                    <th class="bold black p-0 text-left">{{translate('transaction_amount_sum')}} </th>
                                    <td class="p-0" style="padding: 3px 0;">:
                                        {{ \App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($amount_sum)) }}
                                    </td>
                                </tr>
                                <tr>
                                    <th class="bold black p-0 text-left">{{translate('manually_type_transactions')}} </th>
                                    <td class="p-0" style="padding: 3px 0;">:
                                        {{ $manually_type }}
                                    </td>
                                </tr>
                                <tr>
                                    <th class="bold black p-0 text-left">{{translate('automatic_type_transactions')}} </th>
                                    <td class="p-0" style="padding: 3px 0;">:
                                        {{ $automatic_type }}
                                    </td>
                                </tr>
                                <tr>
                                    <th class="bold black p-0 text-left">{{translate('newest_transaction_date')}} </th>
                                    <td class="p-0" style="padding: 3px 0;">:
                                        {{ $newest_transaction_date->created_at }}
                                    </td>
                                </tr>
                                <tr>
                                    <th class="bold black p-0 text-left">{{translate('oldest_transaction_date ')}} </th>
                                    <td class="p-0" style="padding: 3px 0;">:
                                        {{ $oldest_transaction_date->created_at }}
                                    </td>
                                </tr>
                            </table>
                        </td>
