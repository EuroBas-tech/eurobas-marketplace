...
<head>
    ...
    <title>{{ translate('payout_history').' - '.$payout_history->id }}</title>
                ...
                <table class="bs-0">
                    <tr>
                        <th class="h3 p-0 text-left">
                            {{translate('seller_payout_history')}}
                        </th>
                ...
                <table class="bs-0">
                    <tr>
                        <td class="p-0 text-left">
                            <table>
                                <tr>
                                    ...
                                    <td class="p-0" style="padding: 3px 0">: {{ \Carbon\Carbon::parse($payout_history->created_at)->format('d/m/Y') }}</td>
                                </tr>
                            </table>
                        </td>
                        <td>&nbsp;</td>
                        ...
                        <td class="p-0 text-left">
                            <table>
                                <tr>
                                    <th class="bold black p-0 text-left">{{translate('seller')}} </th>
                                    <td class="p-0" style="padding: 3px 0;">:
                                        {{ $payout_history->seller->f_name }} {{ $payout_history->seller->l_name }}
                                    </td>
                                </tr>
                                <tr>
                                    <th class="bold black p-0 text-left">{{translate('payout_history_amount')}} </th>
                                    <td class="p-0" style="padding: 3px 0;">:
                                ...
                                <tr>
                                    ...
                                    <td class="p-0" style="padding: 3px 0;">:
                                        {{ $payout_history->paymentMethod->method_name ?? '/' }}
                                    </td>
                                </tr>
                                <tr>
                                    <th class="bold black p-0 text-left">{{translate('new_pending_amount')}} </th>
                                    <td class="p-0" style="padding: 3px 0;">:
                                        {{ \App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($payout_history->new_pending_withdraw)) }}
                                    </td>
                                </tr>
                                <tr>
                                    <th class="bold black p-0 text-left">{{translate('new_total_earning')}} </th>
                                    <td class="p-0" style="padding: 3px 0;">:
                                        {{ \App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($payout_history->new_total_earning)) }}
                                    </td>
                                </tr>
                                <tr>
                                    <th class="bold black p-0 text-left">{{translate('new_withdrawn')}} </th>
                                    <td class="p-0" style="padding: 3px 0;">:
