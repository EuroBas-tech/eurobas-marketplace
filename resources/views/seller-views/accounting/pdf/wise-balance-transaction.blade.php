...
<head>
    ...
    <title>{{ translate('transaction').' - '.$transaction->transaction_id }}</title>
                ...
                <table class="bs-0">
                    <tr>
                        <th class="h3 p-0 text-left">
                            {{translate('seller_balance_transaction')}}
                        </th>
                ...
                <table class="bs-0">
                    <tr>
                        ...
                        <td class="p-0 text-left">
                            <table>
                                <tr>
                                    <th class="bold black p-0 text-left">{{translate('transaction_seller')}} </th>
                                    <td class="p-0" style="padding: 3px 0;">:
                                        {{ $transaction->seller->f_name }} {{ $transaction->seller->l_name }}
                                    </td>
                                </tr>
                                <tr>
                                    <th class="bold black p-0 text-left">{{translate('transaction_amount')}} </th>
                                    <td class="p-0" style="padding: 3px 0;">:
                                        {{ \App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($transaction->amount)) }}
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <th class="bold black p-0 text-left">{{translate('transaction_type')}} </th>
                                    <td class="p-0" style="padding: 3px 0;">:
                                        {{ $transaction->type }}
                                    </td>
                                </tr>
