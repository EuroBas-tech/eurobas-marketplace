...
<head>
    ...
    <title>{{ translate('payout_histories').' - '.rand(1000, 9999) }}</title>
                ...
                <table class="bs-0">
                    <tr>
                        <th class="h3 p-0 text-left">
                            {{translate('seller_payout_histories_summary')}}
                        </th>
                ...
                <table class="bs-0">
                    <tr>
                        ...
                        <td class="p-0 text-left">
                            <table>
                                <tr>
                                    <th class="bold black p-0 text-left">{{translate('payout_histories_amount_sum')}} </th>
                                    <td class="p-0" style="padding: 3px 0;">:
                                        {{ \App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($amount_sum)) }}
                                    </td>
                                </tr>
                                <tr>
                                    <th class="bold black p-0 text-left">{{translate('newest_payout_histories_date')}} </th>
                                    <td class="p-0" style="padding: 3px 0;">:
                                        {{ $newest_payout_history_date->created_at }}
                                    </td>
                                </tr>
                                <tr>
                                    <th class="bold black p-0 text-left">{{translate('oldest_payout_histories_date ')}} </th>
                                    <td class="p-0" style="padding: 3px 0;">:
                                        {{ $oldest_payout_history_date->created_at }}
                                    </td>
                                </tr>
                            </table>
                        </td>
