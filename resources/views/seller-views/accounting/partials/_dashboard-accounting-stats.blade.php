<div class="col-lg-4">
    <!-- Card -->
    <div class="card custom-card-border h-100 d-flex justify-content-center align-items-center">
        <div class="card-body d-flex flex-column gap-10 align-items-center justify-content-center">
            <img width="48" class="mb-2" src="{{asset('public/assets/back-end/img/withdraw.png')}}" alt="">
            <h3 id="balance-value" class="for-card-count mb-0 fz-24">{{\App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($data['total_earning']))}}</h3>
...
<div class="col-lg-8">
    <div class="row g-2">
        <div class="col-md-6">
            <div class="card card-body custom-card-border h-100 justify-content-center">
                <div class="d-flex gap-2 justify-content-between align-items-center">
                    <div class="d-flex flex-column align-items-start">
                        ...
                        <div class="text-capitalize mb-0">{{translate('Pending_balance')}}</div>
                    </div>
                    <div>
            ...
            <div class="card card-body custom-card-border h-100 justify-content-center">
                <div class="d-flex gap-2 justify-content-between align-items-center">
                    <div class="d-flex flex-column align-items-start">
                        ...
                        <div class="text-capitalize mb-0">{{translate('Already_received')}}</div>
                    </div>
                    <div>
        ...
        <div class="col-md-6">
            <div class="card card-body custom-card-border h-100 justify-content-center">
                <div class="d-flex gap-2 justify-content-between align-items-center">
                    <div class="d-flex flex-column align-items-start">
                        <h3 class="mb-1 fz-24">{{\App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($data['suspended_amount']))}}</h3>
                        <div class="text-capitalize mb-0">{{translate('suspended_amount')}}</div>
                    </div>
                    <div>
