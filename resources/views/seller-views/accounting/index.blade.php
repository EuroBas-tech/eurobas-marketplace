        ...
        <div class="card mb-3 remove-card-shadow">
            <div class="card-body">
                <div class="row g-2" id="order_stats">
                    @include('seller-views.accounting.partials._dashboard-accounting-stats',['data'=>$data])
                </div>
            </div>
        </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">{{translate('send_recieve_balance_request')}}</h5>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-12">
                                <form action="{{route('seller.accounting.send-balance-request')}}" method="POST">
                                    @csrf
                                    <div class="card-body">
                                        <div class="form-group">
                                            <label for="">{{translate('payment_method')}}</label>
                                            <select class="form-control" name="payment_method" >
                                                <option value=""> -- {{ translate('please_choose_a_payment_method') }} -- </option>
                                                @foreach($withdrawal_payment_methods as $method)
                                        ...
                                        <div class="form-group">
                                            <div class="d-flex align-items-center justify-content-between" >
                                                ...
                                                <div class="d-flex align-items-center py-1" >
                                                    <label class="m-0 mx-1" for="">{{translate('all')}}</label>
                                                    <input class="form-check" type="checkbox" name="" id="all-balance">
                                                </div>
                                            </div>
                                            <input class="form-control" placeholder="{{ translate('receive_form_amount_placeholder') }}" type="number" step="0.01" name="amount" value="" id="balance-input" required>
                                        </div>
...
@push('script_2')
    ...
    <script>
        ...
        $(document).ready(function () {
            $('#all-balance').change(function () {
                let balanceValue = $('#balance-value').text().replace(/[^\d.]/g, '');
                let inputField = $('#balance-input');

                if ($(this).is(':checked')) {
                    inputField.val(balanceValue);
                } else {
                    inputField.val('');
                }
            });
        ...
        <div class="card mb-3 remove-card-shadow">
            <div class="card-body">
                <div class="d-flex justify-content-end mb-3" >
                    <a href="{{ route('seller.accounting.wallet-actions-pdf', ['date_type'=>request('date_type'), 'from'=>request('from'), 'to'=>request('to')]) }}" class="btn btn-outline--primary text-nowrap">
