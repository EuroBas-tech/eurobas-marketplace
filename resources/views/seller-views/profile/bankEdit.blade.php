                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" name="bank_name" placeholder="{{ translate('bank_Name_placeholder') }}" value="{{$data->bank_name}}"
                                               class="form-control" id="name"
                                               required>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label for="account_no" class="title-color">{{translate('holder_Name')}} <span class="text-danger">*</span></label>
                                        <input type="text" name="holder_name" placeholder="{{ translate('holder_name_placeholder') }}" value="{{$data->holder_name}}"
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" name="account_no" placeholder="{{ translate('account_no_placeholder') }}" value="{{$data->account_no}}"
                                               class="form-control" id="account_no"
                                               required>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label for="swift" class="title-color">{{translate('Swift No')}}</label>
                                        <input type="text" name="swift" placeholder="{{ translate('swift_no_placeholder') }}" value="{{$data->swift}}" class="form-control"
                                        id="swift_no">
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label for="country" class="title-color">{{translate('country')}} <span class="text-danger">*</span> </label>
                                        <select class="form-control" name="payment_country" id="country" required>
                                            <option value=""> -- {{ translate('choose_payment_country') }} -- </option>
                                            @foreach(COUNTRIES as $country)
                                                <option {{ $country['name'] == $data['payment_country'] ? 'selected' : '' }} value="{{ $country['name'] }}">{{ $country['name'] }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
