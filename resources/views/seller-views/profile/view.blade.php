                                ...
                                <div class="card bank-info-card bg-bottom bg-contain bg-img" style="background-image: url({{asset('/public/assets/back-end/img/bank-info-card-bg.png')}});">
                                    ...
                                    <div class="card-body position-relative">
                                        ...
                                        <ul class="list-unstyled d-flex flex-column gap-4">
                                            ...
                                            <li>
                                                <h3 class="mb-2">{{translate('swift')}} : </h3>
                                                <div>{{$data->swift ?? translate('no_data_found')}}</div>
                                            </li>
                                            <li>
                                                <h3 class="mb-2">{{translate('country')}} :</h3>
                                                <div>{{$data->payment_country ?? 'No Data found'}}</div>
                                            </li>
                                        </ul>
            ...
            <div class="col-md-12">
                <div class="card" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
                    ...
                    <div class="border-bottom d-flex gap-3 flex-wrap justify-content-between align-items-center px-4 py-3">
                        <div class="d-flex gap-2 align-items-center">
                            <img width="20" src="{{asset('public/assets/back-end/img/bank.png')}}" alt="" />
                            <h3 class="mb-0">{{translate('default_payment_method')}}</h3>
                        </div>
                    </div>
                    <!-- End Card Header -->
                    ...
                    <div class="card-body p-30">
                        <div class="row">
                            <div class="col-6">
                                ...
                                <div class="card bank-info-card bg-bottom bg-contain bg-img" style="background-image: url({{asset('public/assets/back-end/img/bank-info-card-bg.png')}});">
                                    <div>
                                        <form class="d-flex align-items-center justify-content-between" method="POST" action="{{route('seller.profile.update-default-payment-method',[$data->id])}}">
                                            @csrf
                                            ...
                                            <select class="form-control" name="default_payment_method" >
                                                ...
                                                @foreach($withdrawal_payment_methods as $method)
                                                    <option {{ $data['default_payment_method'] == $method['id'] ? 'selected' : '' }} value="{{ $method->id }}">{{ $method->method_name }}</option>
                                                @endforeach
                                            </select>
