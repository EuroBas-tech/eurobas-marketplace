                    ...
                    <form action="{{route('seller.shop.update',[$shop->id])}}" method="post"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <label for="refundAddress" class="title-color">{{translate('refund_address')}} <span class="text-danger">*</span></label>
                                    <textarea type="text" rows="4" name="refund_address" value="" class="form-control" id="refundAddress"
                                            required>{{$shop->refund_address}}</textarea>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
