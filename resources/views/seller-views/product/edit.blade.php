                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3 ">
                            <div class="form-group">
                                ...
                                <select class="js-example-basic-multiple form-control" name="origin">
                                    <option  value="{{ $product->origin}}"   {{ $product->origin!=null ? 'selected' : ''}}>{{ $product->origin}}</option>
                ...
                <div class="card-body">
                    <div class="row align-items-end">
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                <div class="d-flex gap-2">
                                    <label class="title-color">{{ translate('price') }} ({{ \App\CPU\BackEndHelper::currency_symbol() }})</label>
                        ...
                        <div class="col-md-6 physical_product_show" id="shipping_cost_multy">
                            <div class="form-group">
                                <div class="form-control h-auto min-form-control-height d-flex align-items-center flex-wrap justify-content-between">
                                    <div class="d-flex gap-2">
                        ...
                        <div class="col-md-6">
                            ...
                            class="js-example-basic-multiple js-states js-example-responsive form-control color-var-select"
                             name="countries[]" multiple="multiple" id="shipping-selector" >
                                  @foreach (COUNTRIES as $country)
                                <option value="{{ $country['code'] }}" @if( $shipping_country!=null && in_array($country['code'], $shipping_country) ) selected @endif>
                                    {{ $country['name'] }}
                                </option>
                            @endforeach
                        </select>
