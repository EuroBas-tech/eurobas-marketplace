...
@section('content')
    ...
    <main class="main-content d-flex flex-column gap-3 py-3">
        <div class="container">
                    ...
                    <div class="d-flex flex-wrap flex-lg-column margin-on-mobile flex-lg-down-grow-1 justify-content-center gap-3">
                        @if($seller_id!=0)
                            @if (auth('customer')->check())
                                <button class="btn btn-primary py-4 flex-lg-down-grow-1 fs-16" data-bs-toggle="modal" data-bs-target="#contact_sellerModal">
                            ...
                            @else
                                <button class="btn btn-primary py-4 flex-lg-down-grow-1 fs-16" data-bs-toggle="modal" data-bs-target="#loginModal">
                                    <i class="bi bi-chat-square-fill"></i> {{translate('Chat_with_Seller')}}
                                </button>
                            @endif
                        @endif
                        ...
                        @if (auth('customer')->id() == '')
                            <button type="button" class="btn btn-outline-primary py-4 flex-lg-down-grow-1 fs-16" data-bs-toggle="modal" data-bs-target="#loginModal"><i class="bi bi-plus-lg"></i> {{ translate('follow') }}</button>
                        @else
                            <button type="button" class="btn btn-outline-primary py-4 flex-lg-down-grow-1 fs-16 follow_button" data-status="{{$follow_status}}"
            ...
            <div class="rounded ov-hidden my-3">
                <div style="background-color:rgba(236, 236, 236, 0.55)" class="p-3 dashed-border">
                    <div class="d-flex gap-4 flex-wrap">
                        @if($shop['id'] != 0)
                            <div class="media gap-3">
                                ...
                                <div class="media-body d-flex flex-column gap-1 pt-3">
                                    <h5>{{ $shop->name}}</h5>
