                            ...
                            <div class="d-flex gap-3 flex-wrap flex-grow-1">
                                    ...
                                    <div class="card-body grid-center">
                                        <div class="d-flex align-items-center justify-content-between w-100">
                                            <div class="d-flex flex-column gap-2" >
                                                <img width="35" src="{{ theme_asset('assets/img/icons/profile-icon2.png') }}" class="dark-support" alt="">
                                                <span class="text-dark" >{{translate('Orders')}}</span>
                                            </div>
                                ...
                                <div class="card border flex-grow-1 product-card-shadow">
                                    <div class="card-body grid-center">
                                        <div class="d-flex align-items-center justify-content-between w-100">
                                            <div class="d-flex flex-column gap-2" >
                                                <img width="35" src="{{theme_asset('assets/img/icons/profile-icon5.png')}}" class="dark-support" alt="">
                                                <span class="text-dark" >{{translate('Wallet')}}</span>
                                            </div>
                                            <h2 class="mb-2">{{ \App\CPU\Helpers::currency_converter($total_wallet_balance) }}</h2>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card border flex-grow-1 product-card-shadow">
                                    <div class="card-body grid-center">
                                        <div class="d-flex align-items-center justify-content-between w-100">
                                            <div class="d-flex flex-column gap-2" >
                                                <img width="35" src="{{theme_asset('assets/img/icons/profile-icon6.png')}}" class="dark-support" alt="">
                                                <span class="text-dark" >{{translate('Loyalty_Point')}}</span>
                                            </div>
                                            <h2 class="mb-2">{{$total_loyalty_point ?? 0}}</h2>
                                        </div>
                                    </div>
                                </div>
                            </div>

                            <div class="mt-30 bg-light rounded dashed-border p-3">
                                ...
                                <div class="mt-4">
                                    <div class="row text-dark">
                                        ...
                                        <dl class="mb-0 flexible-grid" style="--width: 7rem">
                                            <dt class="pe-1 mb-1">{{translate('Phone')}} : </dt>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex flex-wrap align-items-center justify-content-between gap-3">
                                <h3>{{translate('My_Addresses')}}</h3>
                                <a href="{{route('account-address-add')}}" class="btn btn-outline-secondary rounded px-3 px-sm-4">
                            ...
                            <div class="mt-3">
                                <div class="row gy-3 text-dark">
                                    ...
                                    <div class="col-md-12">
                                        <div class="card border-0 product-card-shadow">
