                                    ...
                                    <div>
                                        <div class="col-lg-12">
                                            <div class="form-group mb-3">
                                                <label for="delivery_service_name">{{translate('delivery_service_name')}}</label>
                                                <input readonly class="form-control custom-block-size" type="text" id="delivery_service_name" name="delivery_service_name" value="{{$order->delivery_service_name}}" placeholder=". . .">
                                            </div>
                                        </div>
                                    </div>
...
@push('script')
    ...
    <script>
        function copyToClipboard(button) {
            let input = $('#third_party_tracking_number');
            navigator.clipboard.writeText(input.val());

            let icon = $(button).find('.copy-icon');
            icon.removeClass('bi-clipboard').addClass('bi-check2');

            setTimeout(() => icon.removeClass('bi-check2').addClass('bi-clipboard'), 2000);
        }
    </script>
