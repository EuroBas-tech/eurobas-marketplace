                            ...
                            <div class="mt-4">
                                <div class="table-responsive">
                                    <table class="table align-middle table-bordered compare--table">
                                                ...
                                                @if ($web_config['brand_setting'])
                                                    ...
                                                    <td>
                                                        <a href="{{ route('products',['id'=> $compare_list->product->brand['id'],'data_from'=>'brand','page'=>1]) }}">
                                                            <img width="48" src="{{cloudfront("brand/".$compare_list->product->brand->image)}}"
                                        ...
                                        @if($compare_lists->count()==0)
                                            <tr class="rounded" >
                                                <td class="bg-light rounded dashed-border" ><h5 class="text-center">{{translate('not_found_anything')}}</h5></td>
                                            </tr>
                                        @endif
                                        </tbody>
                                    </table>
