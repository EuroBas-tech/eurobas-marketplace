...
<head>
    ...
    <title>{{ucwords('Order overview')}}</title>
    ...
    <table class="content-position mb-30">
        <tr>
            ...
            <th class="p-0 text-right">
                <img height="40" src="{{asset("storage/app/public/company/dark-logo.png")}}" alt="">
            </th>
        </tr>
        ...
        <tr>
            <th class="content-position-y text-left">
                <h4 class="text-uppercase mb-1 fz-14">
                    {{ucwords('order_overview')}} #{{ $order->id }}
                </h4> <br>
                <h4 class="text-uppercase mb-1 fz-14">
                    {{ucwords('Shop Name')}}
        ...
        <table>
            <tr>
                <th class="content-position-y bg-light py-4">
                    ...
                    <div>
                        <h4>
                        {{ucwords('Please note: This document is an overview of your purchase from an external eurobas.de seller. An invoice with VAT details can be requested from the respective seller.')}}
