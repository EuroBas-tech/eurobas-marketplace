...
<head>
    ...
    <!-- ======= MAIN STYLES ======= -->
    <link rel="stylesheet" href="{{ theme_asset('assets/css/style.css?v=786123645') }}"/>
    ...
    <!-- ======= CUSTOMIZE STYLES ======= -->
    <link rel="stylesheet" href="{{ theme_asset('assets/css/custom.css?v=13796843') }}"/>
...
<script src="{{ theme_asset('assets/js/custom2.js?v=1237453') }}"></script>
