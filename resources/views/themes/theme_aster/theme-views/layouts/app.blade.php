...
<link rel="alternate" href="https://eurobas.com/ja" hreflang="ja" />
    ...
    <link href="https://fonts.googleapis.com/css2?family=Cairo:wght@200..1000&family=Mulish:wght@300;400;500;600;700;800;900&family=Rubik:ital,wght@0,300..900;1,300..900&display=swap" rel="stylesheet">

    <!-- ======= BEGIN GLOBAL MANDATORY STYLES ======= -->
    <link rel="stylesheet" rel="preload" href="{{ theme_asset('assets/css/bootstrap.min.css') }}"/>
    <link rel="stylesheet" rel="preload" href="{{ theme_asset('assets/css/bootstrap-icons.min.css') }}"/>
    <link rel="stylesheet" href="{{ theme_asset('assets/plugins/swiper/swiper-bundle.min.css') }}"/>
    <!-- ======= END BEGIN GLOBAL MANDATORY STYLES ======= -->
    <!-- sweet alert Css -->
    <link rel="stylesheet" media="print" onload="this.media='all'" href="{{ theme_asset('assets/plugins/sweet_alert/sweetalert2.css') }}">
    <!--Toastr -->
    <link media="print" onload="this.media='all'" rel="stylesheet" href="{{theme_asset('assets/css/toastr.css')}}"/>

    <!-- ======= MAIN STYLES ======= -->
    <link rel="stylesheet" href="{{ theme_asset('assets/css/style.css?v=1234') }}"/>
    ...
    <!-- ======= CUSTOMIZE STYLES ======= -->
    <link rel="stylesheet" href="{{ theme_asset('assets/css/custom.css?v=123456') }}"/>
...
<div class="preloader d--none" id="loading">
    <img width="200"
         src="{{theme_asset('assets/img/loader.gif')}}"
...
<script defer src="{{ theme_asset('assets/js/custom.js?v=12345497456') }}"></script>
