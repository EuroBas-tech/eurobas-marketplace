                            ...
                            <div class="col-md-6">
                                <center>
                                    <img class="upload-img-view upload-img-view__banner" id="viewerBanner"
                                            ...
                                            src="{{cloudfront('shop')}}/{{\App\CPU\Helpers::get_business_settings('shop_banner')}}"alt="banner image"/>
                                </center>
                                ...
                                <div class="col-lg-6 form-group">
                                    <center>
                                        <img class="upload-img-view upload-img-view__banner" id="viewerBottomBanner"
                                                onerror="this.src='{{asset('public/assets/back-end/img/400x400/img2.jpg')}}'"
                                                src="{{cloudfront('shop')}}/{{\App\CPU\Helpers::get_business_settings('bottom_banner')}}"alt="banner image"/>
                                    </center>
                                ...
                                <div class="col-lg-6 form-group">
                                    <center>
                                        <img class="upload-img-view upload-img-view__banner" id="viewerOfferBanner"
                                                onerror="this.src='{{asset('public/assets/back-end/img/400x400/img2.jpg')}}'"
                                                src="{{cloudfront('shop')}}/{{\App\CPU\Helpers::get_business_settings('offer_banner')}}"alt="banner image"/>
                                    </center>
