...
@section('title', translate('Seller_FAQ'))
@push('css_or_js')
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0">{{translate('seller_help_topic_Table')}} </h5>
                            ...
                            <table
                                ...
                                @foreach($helps as $k=>$help)
                                    <tr id="data-{{$help->id}}">
                                        ...
                                        <td>
                                            <form action="{{ route('admin.seller-help-topic.status', ['id'=>$help['id']])}}" method="get" id="helpTopic_status{{$help['id']}}_form" class="helpTopic_status_form">
        ...
        <div class="modal fade" tabindex="-1" role="dialog" id="addModal">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form action="{{ route('admin.seller-help-topic.add-new') }}" method="post" id="addForm">
                        @csrf
        ...
        $(document).on('click', '.delete', function () {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        url: "{{route('admin.seller-help-topic.delete')}}",
                        method: 'POST',
                        data: {id: id},
                        success: function () {
