...
@section('title', translate('seller_reports'))
                    ...
                    <div class="row  gx-2 gy-3 align-items-center text-{{Session::get('direction') === "rtl" ? 'right' : 'left'}}">
                        ...
                        <div class="col-sm-6 col-md-3">
                            <select class="form-control __form-control" name="date_type" id="date_type">
                                <option value="all_time" {{ $date_type == 'all_time'? 'selected' : '' }}>{{translate('all_time')}}</option>
            ...
            <div class="card mb-3 remove-card-shadow">
                <div class="card-body">
                    ...
                    <div class="row g-2" id="order_stats">
                        @include('seller-views.partials._dashboard-report-wallet-stats',['data'=>$data])
                    </div>
                </div>
            </div>
        @endif
