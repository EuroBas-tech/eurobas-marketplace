...
@section('title', translate('ads_List'))
    ...
    <div class="content container-fluid">
        ...
        <div class="mb-4">
            <h2 class="h1 mb-0 text-capitalize d-flex align-items-center gap-2">
                <img width="20" src="{{asset('/public/assets/back-end/img/ad.png')}}" alt="">
                {{translate('ads_list')}}
                <span class="badge badge-soft-dark radius-50">{{\App\Model\Ad::count()}}</span>
            </h2>
        </div>
        <!-- End Page Title -->
                    ...
                    <div class="col-sm-4 col-md-6 col-lg-8 mb-2 mb-sm-0">
                        <div class="d-flex justify-content-sm-end">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                <li>
                                    <a class="dropdown-item" href="{{route('admin.ad.export',['search'=>request('search')])}}">
                    ...
                    <tbody>
                        @foreach($ads as $key=>$ad)
                            <tr>
                                ...
                                <td class="mx-5" >{{$ad['category']['name']  ?? '/' }}</td>
                                <td>{{$ad['brand']['name'] ?? '/' }}</td>
                                <td>{{$ad['model']['name'] ?? '/' }}</td>
                                <td>{{$ad['user']['name']  ?? '/' }}</td>
                                <td>
...
@push('script_2')
    <script>
        $('.ad_status_form').on('submit', function(event){
