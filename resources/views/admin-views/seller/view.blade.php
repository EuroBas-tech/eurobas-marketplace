        ...
        <div class="card card-top-bg-element mb-5">
            <div class="card-body">
                ...
                <div class="d-flex gap-3 flex-wrap flex-lg-nowrap">
                    <div class="border p-3 w-170 h-100">
                    ...
                    <div class="row gy-3 flex-grow-1 w-100">
                        <div class="col-sm-6 col-xxl-6">
                            ...
                            <div class="pair-list">
                                ...
                                <div>
                                    <span class="">{{translate('company_name')}}</span>
                                    <span>:</span>
                                    <span class="value">{{$seller->shop->company_name}}</span>
                                </div>

                                <div>
                                    <span class="">{{translate('business_phone')}}</span>
                                    <span>:</span>
                                    <span class="value">{{$seller->shop->business_phone}}</span>
                                </div>
                                <div>
                                    <span class="">{{translate('business_email')}}</span>
                                    <span>:</span>
                                    <span class="value">{{$seller->shop->business_email}}</span>
                                </div>
                                <div>
                                    <span class="">{{translate('product_category')}}</span>
                                    <span>:</span>
                                    <span class="value">{{$seller->shop->product_category=="other"? "Other*" . $seller->shop->product_category_other  : $seller->shop->product_category}}</span>
                                </div>
                                <div>
                                    <span class="">{{translate('shipping_info')}}</span>
                                    <span>:</span>
                                    <span class="value">{{$seller->shop->shipping_info}}</span>
                                </div>
                                <div>
                                    <span class="">{{translate('business_country')}}</span>
                                    <span>:</span>
                                    <span class="value">{{$seller->shop->business_country}}</span>
                                </div>
                                <div>
                                    <span class="">{{translate('business_city')}}</span>
                                    <span>:</span>
                                    <span class="value">{{$seller->shop->business_city}}</span>
                                </div>
                                <div>
                                    <span class="">{{translate('Store_Address')}}</span>
                                    <span>:</span>
                                    <span class="value">{{$seller->shop->Store_Address}}</span>
                                </div>
                                <div>
                                    <span class="">{{translate('business_street_address')}}</span>
                                    <span>:</span>
                                    <span class="value">{{$seller->shop->business_street_address}}</span>
                                </div>
                                <div>
                                    <span class="">{{translate('business_place_number')}}</span>
                                    <span>:</span>
                                    <span class="value">{{$seller->shop->business_place_number}}</span>
                                </div>
                                <div>
                                    <span class="">{{translate('business_model')}}</span>
                                    <span>:</span>
                                    <span class="value">{{$seller->shop->business_model}}</span>
                                </div>
                                <div>
                                    <span class="">{{translate('company_type')}}</span>
                                    <span>:</span>
                                    <span class="value">{{$seller->shop->company_type}}</span>
                                </div>
                                <div>
                                    <span class="">{{translate('optional_commercial_register')}}</span>
                                    <span>:</span>
                                    <span class="value">{{$seller->shop->optional_commercial_register}}</span>
                                </div>
                                <div>
                                    <span class="">{{translate('Tax_number')}}</span>
                                    <span>:</span>
                                    <span class="value">{{$seller->shop->optional_tax_number}}</span>
                                </div>
                                <div>
                        ...
                        <div class="col-sm-6 col-xxl-6">
                            ...
                            <div class="pair-list">
                                ...
                                <div>
                                    <span class="">{{translate('date_of_birth')}}</span>
                                    <span>:</span>
                                    <span class="value">{{$seller->date_of_birth}}</span>
                                </div>
                                <div>
                                    <span class="">{{translate('nationality')}}</span>
                                    <span>:</span>
                                    <span class="value">{{$seller->nationality}}</span>
                                </div>
                                <div>
                                    <span class="">{{translate('sex')}}</span>
                                    <span>:</span>
                                    <span class="value">{{$seller->sex}}</span>
                                </div>
                                <div>
                                    <span class="">{{translate('country')}}</span>
                                    <span>:</span>
                                    <span class="value">{{$seller->country}}</span>
                                </div>
                                <div>
                                ...
                                <div>
                                    <span class="">{{translate('street_address')}}</span>
                                    <span>:</span>
                                    <span class="value">{{$seller->street_address}}</span>
                                </div>
                                <div>
                                    <span class="">{{translate('house_number')}}</span>
                                    <span>:</span>
                                    <span class="value">{{$seller->house_number}}</span>
                                </div>
                                <div>
                                    <span class="">{{translate('postal_code')}}</span>
                                    <span>:</span>
                                    <span class="value">{{$seller->postal_code}}</span>
                                </div>
                                ...
                                <div class="bg-light p-3 border border-primary-light rounded">
                                    ...
                                    <div class="d-flex gap-5">
                                        <div class="pair-list">
                                            ...
                                            <div>
                                                <span class="key text-nowrap">{{translate('Swift')}}</span>
                                                <span class="px-2">:</span>
                                                <span class="value">{{ $seller->swift ? $seller->swift : translate('no_data_found') }}</span>
                                            </div>
                                        </div>
                                        <div class="pair-list">
                                            <div>
                                                <span class="key text-nowrap">{{translate('country')}}</span>
                                                <span class="px-2">:</span>
                                                <span class="value">{{ $seller->payment_country ? $seller->payment_country : translate('no_data_found') }}</span>
                                            </div>

                                            <div>
                                                <span class="key text-nowrap">{{translate('account_number')}} : </span>
                                                <span class="px-2"></span>
                                                <span class="value mx-2">{{ $seller->account_no ? $seller->account_no : translate('no_data_found') }}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="row justify-content-between align-items-center g-2 mb-3">
                    <div class="col-sm-6">
                        <h4 class="d-flex align-items-center text-capitalize gap-10 mb-0">
                            ...
                            {{translate('Sample of products images')}}
                        </h4>
                    </div>
                    <div class="product-images-container">
                        @php
                        $productImages = json_decode($seller->shop->images_product, true);
                    @endphp
