...
<head>
    ...
    <title>{{ translate('cost').' - '.$cost->id }}</title>
                ...
                <table class="bs-0">
                    <tr>
                        <td class="p-0 text-left">
                            <table>
                                <tr>
                                    ...
                                    <td class="p-0" style="padding: 3px 0">: {{ \Carbon\Carbon::parse($cost->created_at)->format('d/m/Y') }}</td>
                                </tr>
                            </table>
                        </td>
                        <td>&nbsp;</td>
                        ...
                        <td class="p-0 text-left">
                            <table>
                                <tr>
                                    <th class="bold black p-0 text-left">{{translate('cost_title')}} </th>
                                    <td class="p-0" style="padding: 3px 0;">:
                                        {{ $cost->title }}
                                    </td>
                                </tr>
                                <tr>
                                    <th class="bold black p-0 text-left">{{translate('cost_description')}} </th>
                                    <td class="p-0" style="padding: 3px 0;">:
                                        {{ $cost->description }}
                                    </td>
                                </tr>
                                <tr>
                                    <th class="bold black p-0 text-left">{{translate('cost_amount')}} </th>
                                    <td class="p-0" style="padding: 3px 0;">:
                                        {{\App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($cost->amount)) }}
                                    </td>
                                </tr>
                            </table>
                        </td>
