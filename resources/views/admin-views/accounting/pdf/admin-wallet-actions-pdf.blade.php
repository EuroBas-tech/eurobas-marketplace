...
<head>
    ...
    <title>{{ translate('admin_wallet').' - '.time() }}</title>
                ...
                <table class="bs-0">
                    <tr>
                        ...
                        <td class="p-0 text-left">
                            <table>
                                <tr>
                                    <th class="bold black p-0 text-left">{{translate('total_commission_earned')}} </th>
                                ...
                                <tr>
                                    <th class="bold black p-0 text-left">{{translate('costs_and_expenses')}} </th>
                                    <td class="p-0" style="padding: 3px 0;">:
                                        {{\App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($data['costs_and_expenses'])) }}
                                    </td>
                                </tr>
                                <tr>
                                    <th class="bold black p-0 text-left">{{translate('total_net_profit')}} </th>
                                    <td class="p-0" style="padding: 3px 0;">:
                                        {{\App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($data['commission_earned'] - $data['costs_and_expenses']))}}
                                    </td>
                                </tr>
                                <td>&nbsp;</td>
                                <td>&nbsp;</td>
                                ...
                                <tr>
                                    @if($date_type == 'all_time')
                                        <th class="bold black p-0 text-left">{{translate('this_results_of')}} : </th>
                                        <td class="p-0" style="padding: 3px 0;">:
                                            {{ translate('all_time') }}
                                        </td>
                                    @elseif($date_type == 'custom_date')
                                        <th class="bold black p-0 text-left">{{translate('this_result_between')}} : </th>
                                        <td class="p-0" style="padding: 3px 0;">:
                                            {{ $from }} - {{ $to }}
                                        </td>
                                    @else
