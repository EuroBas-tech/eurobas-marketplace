    ...
    <div class="content container-fluid">
        ...
        <div class="mb-3">
            <h2 class="h1 mb-0 d-flex gap-10">
                <img src="{{env_asset('assets/back-end/img/brand-setup.png')}}" alt="">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        <label class="title-color">{{translate('category_slug')}}<span class="text-danger">*</span></label>
                                        <input type="text" name="slug" class="form-control" placeholder="{{translate('slug')}}" required>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <center>
                                            <img
                                                ...
                                                id="viewer"
                                                src="{{env_asset('assets/back-end/img/900x400/img1.jpg')}}"
                                                alt="image"/>
                                        </center>
                                    </div>
                                </div>
                ...
                <div class="card">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <img class="rounded" width="64"
                                                onerror="this.src='{{env_asset('assets/front-end/img/image-place-holder.png')}}'"
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-center gap-10">
                                            <a class="btn btn-outline-info btn-sm square-btn"
                                                ...
                                                href="{{route('admin.category-type.edit',[$category['id']])}}">
                                                <i class="tio-edit"></i>
                                            </a>
                    ...
                    @if(count($categories)==0)
                        <div class="text-center p-4">
                            <img class="mb-3 w-160" src="{{env_asset('assets/back-end')}}/svg/illustrations/sorry.svg" alt="Image Description">
        ...
        $(document).on('click', '.delete', function () {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        url: "{{route('admin.category-type.delete')}}",
                        method: 'POST',
                        data: {id: id},
                        success: function () {
