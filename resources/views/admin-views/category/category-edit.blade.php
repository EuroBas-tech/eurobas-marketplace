                                ...
                                <div class="{{ $category['parent_id']==0 || $category['position'] == 1 ? 'col-lg-6':'col-12' }}">
                                    ...
                                    <div class="form-group w-100">
                                        ...
                                        <select id="exampleFormControlSelect1" name="category_type"
                                            ...
                                            <option {{ $category['category_type'] == 'vehicles' ? 'selected' : '' }} value="vehicles">{{translate('vehicles')}}</option>
                                            <option {{ $category['category_type'] == 'real estate' ? 'selected' : '' }} value="real estate">{{translate('real_estate')}}</option>
                                            <option {{ $category['category_type'] == 'electronics' ? 'selected' : '' }} value="electronics">{{translate('electronics')}}</option>
                                            <option {{ $category['category_type'] == 'home appliances' ? 'selected' : '' }} value="home appliances">{{translate('home_appliances')}}</option>
                                            <option {{ $category['category_type'] == 'industrial machines' ? 'selected' : '' }} value="industrial machines">{{translate('industrial_machines')}}</option>
