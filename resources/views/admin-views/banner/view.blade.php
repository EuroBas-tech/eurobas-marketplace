                ...
                <div class="card">
                                                ...
                                                <div class="col-sm-3 col-md-3 col-lg-3">
                                                    ...
                                                    <div class="col-sm-3 col-md-6 col-lg-3">
                                                        <select class="form-control" name="for_mobile" id="for_mobile">
                                                            ...
                                                            <option value="1" {{ $for_mobile === "1" ? 'selected':'' }}>Mobile</option>
                                                            <option value="0" {{ $for_mobile === "0" ? 'selected':'' }}>Desktop</option>
                                                        </select>
                                                    </div>
                    ...
                    <div class="table-responsive">
                        <table id="columnSearchDatatable"
                            ...
                            <tr>
                                <th class="pl-xl-5">{{translate('id')}}</th>
                                <th class="pl-xl-5">{{translate('priority')}}</th>
                                <th>{{translate('image')}}</th>
                                <th>{{translate('banner_type')}}</th>
                                <th>{{translate('Lang')}}</th>
                                <th>{{translate('Platform-banner')}}</th>
