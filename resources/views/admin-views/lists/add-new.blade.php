...
@section('title', translate('list_item_Add').' - '.translate($list->name))
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="attribute_id" class="title-color">{{ translate('list_attribute')}}<span class="text-danger">*</span></label>
                                    <select class="form-control" id="attribute_id" disabled>
                                        @foreach($lists as $list_item)
                                            <option {{ $list_item['name'] == $list['name'] ? 'selected' : '' }} value="{{$list_item->id}}">{{translate($list_item->name)}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group lang_form" id="">
                                    ...
                                    <input type="text" name="value" class="form-control" id="value" value="" placeholder="{{translate('ex')}} : {{translate('diesel')}}" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
