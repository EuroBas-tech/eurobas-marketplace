            ...
            <div class="card card-body h-100 justify-content-center">
                <div class="d-flex gap-2 justify-content-between align-items-center">
                    <div class="d-flex flex-column align-items-start">
                        ...
                        <div class="text-capitalize mb-0">{{translate('Total Available To Withdraw')}}</div>
                    </div>
                    <div>
            ...
            <div class="card card-body h-100 justify-content-center">
                <div class="d-flex gap-2 justify-content-between align-items-center">
                    <div class="d-flex flex-column align-items-start">
                        ...
                        <div class="text-capitalize mb-0">{{translate('Total Already Withdrawn')}}</div>
                    </div>
                    <div>
                        <img width="40" class="mb-2" src="{{asset('public/assets/back-end/img/aw.png')}}" alt="">
                    </div>
                </div>
            </div>
        </div>
