                    ...
                    <div class="row gy-3 flex-grow-1">
                        ...
                        <div class="col-sm-6 col-xl-4">
                            ...
                            <div class="pair-list">
                                ...
                                @if($product->origin )
                                    <div>
                                        <span class="key text-nowrap">{{translate(' Origin Product ')}}</span>
                                        <span>:</span>
                                ...
                                <div>
                                    <span class="key text-nowrap">{{translate(' shipping country ')}}</span>
                                    <span>:</span>
                                    <span class="value">{{$product->shipping_country}}</span>
                                </div>
                            @endif
                            </div>
                        </div>
