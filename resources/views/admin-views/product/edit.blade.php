        ...
        <form class="product-form text-start" action="{{route('admin.product.update',$product->id)}}" method="post" enctype="multipart/form-data" id="product_form">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3 physical_product_show">
                         ...
                         <div class="col-md-6 col-lg-4 col-xl-3 ">
                            <div class="form-group">
                                <label class="title-color">{{ translate('The origin of the product facility') }}</label>
            ...
            <div class="card mt-3 rest-part physical_product_show">
                <div class="card-header">
                    <div class="d-flex gap-2">
                        <i class="tio-user-big"></i>
                        <h4 class="mb-0">{{ translate('Select Country Shipping') }}</h4>
                    </div>
                </div>
                <div class="card-body">
                    <div class="row align-items-end">
                        <div class="col-md-6">
                            <div class="mb-3 d-flex align-items-center gap-2">
                                <label for="sipping" class="title-color mb-0">
                                    {{ translate('select_Shipping_country') }} :
                                </label>
                                <label class="switcher">
                                    <input type="checkbox" class="switcher_input" id="shipping_switcher" value="{{ old('shipping_active') }}"
                            ...
                            class="js-example-basic-multiple js-states js-example-responsive form-control color-var-select"
                             name="countries[]" multiple="multiple" id="shipping-selector"  disabled>
                                  @foreach (COUNTRIES as $country)
