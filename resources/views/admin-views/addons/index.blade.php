...
@push('css_or_js')
    ...
    <link rel="stylesheet" href="{{ env_asset('assets/back-end/vendor/swiper/swiper-bundle.min.css')}}"/>
@endpush
    ...
    <div class="content container-fluid">
        ...
        <div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-4 pb-2">
            <h2 class="h1 mb-0 text-capitalize d-flex align-items-center gap-2">
                <img src="{{env_asset('assets/back-end/img/teheme-setup.png')}}" alt="">
            ...
            <div class="text-primary d-flex align-items-center gap-3 font-weight-bolder">
                ...
                <div class="ripple-animation" data-toggle="modal" data-target="#settingModal">
                    <img src="{{env_asset('assets/back-end/img/icons/info.svg')}}" class="svg" alt="">
                </div>
            </div>
                                    ...
                                    <div class="swiper mySwiper pb-3">
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <img src="{{env_asset('assets/back-end/img/slider-1.png')}}"
                                                     loading="lazy"
                                                     alt="" class="dark-support rounded">
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="d-flex flex-column align-items-center mx-w450 mx-auto">
                                                    <img src="{{env_asset('assets/back-end/img/slider-2.png')}}"
                                                         loading="lazy"
                                            ...
                                            <div class="swiper-slide">
                                                <div class="d-flex flex-column align-items-center mx-w450 mx-auto">
                                                    <img src="{{env_asset('assets/back-end/img/slider-3.png')}}"
                                                         loading="lazy"
                                                         alt="" class="dark-support rounded mb-4">
                                                    <p>
                        ...
                        <div class="col-sm-6 col-lg-5 col-xl-4 col-xxl-3">
                            ...
                            <div class="mt-5 card px-3 py-2 d--none" id="progress-bar">
                                <div class="d-flex flex-wrap align-items-center gap-3">
                                    <div class="">
                                        <img width="24" src="{{env_asset('assets/back-end/img/zip.png')}}" alt="">
                                    </div>
                    ...
                    <div class="card theme-card {{ theme_root_path() == $key ? 'theme-active':'' }}">
                            ...
                            <div class="d-flex gap-2 gap-sm-3 align-items-center">
                                @if ($data['is_published'] == 0)
                                    <button class="text-danger bg-transparent p-0 border-0" data-toggle="modal"
                                            ...
                                            src="{{env_asset('assets/back-end/img/icons/delete.svg')}}" class="svg"
                                            alt=""></button>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body px-4 px-sm-5 text-center">
                                                    <div class="mb-3 text-center">
                                                        <img width="75"
                                                             src="{{env_asset('assets/back-end/img/delete.png')}}"
                                                             alt="">
                                                    </div>
                                ...
                                @endif
                                    ...
                                    <button class="text-muted bg-transparent p-0 border-0" data-toggle="modal"
                                            ...
                                            src="{{env_asset('assets/back-end/img/icons/check.svg')}}" class="svg {{ $data['is_published'] == 1 ? 'text--primary' : '' }}"
                                            alt=""></button>
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body px-4 px-sm-5 text-center">
                                                    <div class="mb-3 text-center">
                                                        <img width="75"
                                                             src="{{env_asset('assets/back-end/img/shift.png')}}"
                                                             alt="">
                                                    </div>
                        ...
                        <div class="p-2 p-sm-3">
                            <div class="aspect-ration-3:2 border border-color-primary-light radius-10">
                                ...
                                onerror="this.src='{{env_asset('assets/back-end/img/placeholder.png')}}'"\
...
@push('script')
    <script src="{{ env_asset('assets/back-end/vendor/swiper/swiper-bundle.min.js')}}"></script>
