                ...
                <div class="card">
                    <div class="card-body text-capitalize d-flex flex-column gap-4">
                        ...
                        <div class="">
                            ...
                            <select {{$order['order_status'] == 'delivered'?'disabled':''}} name="order_status" onchange="order_status(this.value)"
                                class="status form-control" data-id="{{$order['id']}}">
                                <option value="delivered" {{$order->order_status != 'delivered'?'selected':''}} >{{translate('change_order_status')}} </option>
