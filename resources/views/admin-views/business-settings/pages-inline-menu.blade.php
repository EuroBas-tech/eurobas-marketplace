<div class="inline-page-menu my-4">
    <ul class="list-unstyled">
        ...
        <li class="{{ Request::is('admin/helpTopic/list') ?'active':'' }}"><a href="{{route('admin.business-settings.instructions-for-use')}}">{{translate('instructions_for_use')}}</a></li>
        <li class="{{ Request::is('admin/seller-help-topic/list') ?'active':'' }}"><a href="{{route('admin.seller-help-topic.list')}}">{{translate('Seller_FAQ')}}</a></li>
