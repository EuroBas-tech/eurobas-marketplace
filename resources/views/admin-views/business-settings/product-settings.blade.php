                ...
                <form action="{{ route('admin.product-settings.update-product-settings') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row align-items-end">
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="form-group">
                                <div class="d-flex gap-2">
                                    <label class="title-color d-flex" for="ad_images_size">{{translate('ad_images_size')}}</label>
                                    <span class="input-label-secondary cursor-pointer" data-toggle="tooltip" data-placement="right"
                                    title="{{translate('set_the_ad_images_size')}}" >
                                        <img width="16" src="{{asset('/assets/back-end/img/info-circle.svg')}}" alt="">
                                    </span>
                                </div>
                                <input class="form-control" type="number" name="ad_images_size" id="ad_images_size"
                                value="{{ $ad_images_size }}"
                                placeholder="{{translate('ex')}} : {{translate('4')}}">
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-4">
                            <div class="form-group">
                                <div class="d-flex gap-2">
                                    <label class="title-color d-flex" for="maximum_ad_images_number">{{translate('maximum_ad_images_number')}}</label>
                                    <span class="input-label-secondary cursor-pointer" data-toggle="tooltip" data-placement="right"
                                    title="{{translate('set_the_maximum_ad_images_number')}}" >
                                        <img width="16" src="{{asset('/assets/back-end/img/info-circle.svg')}}" alt="">
                                    </span>
                                </div>
                                <input class="form-control" type="number" name="maximum_ad_images_number" id="maximum_ad_images_number"
                                value="{{ $maximum_ad_images_number }}"
                                placeholder="{{translate('ex')}} : {{translate('10')}}">
                            </div>
                        </div>
                        <div class="col-12">
