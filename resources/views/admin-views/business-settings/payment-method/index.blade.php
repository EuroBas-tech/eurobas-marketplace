                    ...
                    <div class="card">
                        <form action="{{route('admin.business-settings.payment-method.addon-payment-set')}}" method="POST"
                            ...
                            <div class="card-header d-flex flex-wrap align-content-around">
                                ...
                                @php($additional_data = $payment['additional_data'] != null ? $payment['additional_data'] : [])

                                <?php
                                    if ($additional_data != null){
                                        $img_path = cloudfront('payment_modules/gateway_image/'. $additional_data['gateway_image'] ?? '');
                                    }else{
                                        $img_path = cloudfront('/assets/back-end/img/modal/payment-methods/'.$payment->key_name.'.png');
                                    }
                                ?>
