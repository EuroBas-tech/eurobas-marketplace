                ...
                <div class="card-body">
                    <div class="row align-items-end">
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="form-group">
                                <label class="title-color d-flex align-items-center gap-2">
                                    {{translate('minimum_withdraw_duration')}}
                                    <span class="input-label-secondary cursor-pointer" data-toggle="tooltip" data-placement="right" title="{{translate('minimum_withdraw_duration_title')}}">
                                        <img width="16" src="{{asset('assets/back-end/img/info-circle.svg')}}" alt="">
                                    </span>
                                </label>
                                @php($minimumWithdrawDuration=\App\Model\BusinessSetting::where('type','minimum_withdraw_duration')->first())
                                <input type="number" class="form-control" name="minimum_withdraw_duration" value="{{isset($minimumWithdrawDuration)?$minimumWithdrawDuration->value:0}}" placeholder="{{translate('ex: 70')}}" min="0" max="100">
                            </div>
                        </div>
                        <div class="col-xl-4 col-md-6">
                            <div class="form-group">
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="d-flex justify-content-between align-items-center gap-10 form-control form-group">
                                ...
                                @php($automatic_balance_request=\App\CPU\Helpers::get_business_settings('automatic_balance_request'))

                                <label class="switcher" for="automatic_balance_request">
                                    <input type="checkbox" class="switcher_input" name="automatic_balance_request" id="automatic_balance_request" value="1"
                                     {{$automatic_balance_request==1?'checked':''}}
                                     onclick="toogleModal(event,'automatic_balance_request','pos-seller-on.png','pos-seller-off.png','{{translate('want_to_Turn_ON_automatic_balance_request')}}','{{translate('want_to_Turn_OFF_automatic_balance_request')}}',`<p>{{translate('if_enabled_automatic_balance_request_option_will_be_send_requests_automatically')}}</p>`,`<p>{{translate('if_disabled_automatic_balance_request_option_will_be_send_requests_automatically')}}</p>`)">
                                    <span class="switcher_control"></span>
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="form-group">
                                ...
                                @php($automaticBalanceRequestDuration=\App\Model\BusinessSetting::where('type','automatic_balance_request_duration')->first())
