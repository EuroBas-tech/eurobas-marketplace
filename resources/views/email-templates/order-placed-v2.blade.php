...
<div style="width:650px;margin:auto; background-color:white;margin-top:100px;
    ...
    <table style="background-color: rgb(255, 255, 255);width: 90%;margin: 10px auto;height:72px; border-bottom:1px ridge;">
        <tbody>
            <tr>
                <td>
                ...
                <td style="width:50%;vertical-align: top;">
                    <div style="text-align:right;margin-top:10px;">
                        ...
                        <div style="margin-top: 10px;">
                            ...
                            <span style="color: #414141 !important ; text-transform: capitalize;margin-bottom: 5px;">
                    ...
                    {{-- <div style="margin-top:100px;"> --}}
                        ...
                        <?php $subtotal=($details['price'])*$details->qty; ?>
                            <tr style="text-align: center;">
                                ...
                                <td style="padding:5px;">{{\App\CPU\Helpers::currency_converter($subtotal)}}</td>
                            </tr>
                            <?php
                ...
                <td style="text-align: right">
                    <table style="width: 46%;margin-left:41%; display: inline;text-transform: capitalize; ">
                        ...
                        <tr>
                            ...
                            <td>{{\App\CPU\Helpers::currency_converter($shipping)}}</td>
                        </tr>
                        @endif
                        <tr>
                            <td  >{{\App\CPU\translate('coupon_discount')}} : </td>
                            <td>
                                -{{\App\CPU\Helpers::currency_converter($order->discount_amount)}}  </td>
                        </tr>
                        <tr class="border-bottom">
                            <td  >{{\App\CPU\translate('discount_on_product')}} : </td>
                            <td>
                                -{{\App\CPU\Helpers::currency_converter($total_discount_on_product)}} </td>
                        </tr>
                        @if ($order->order_type != 'default_type')
                        <tr class="border-bottom">
                            <th  >{{\App\CPU\translate('extra_discount')}} : </th>
                            <td>
                                -{{\App\CPU\Helpers::currency_converter($extra_discount)}} </td>
                        </tr>
                        @endif
                        <tr class="bg-primary">
    ...
    <table style="background-color: rgb(255, 255, 255);width: 90%;margin:auto;margin-top:30px;">
        <tbody style="">
                    ...
                    <td>
                      ...
                      ?>
                          ...
                          <div style="margin-top: 50px; margin-bottom:30px;text-align: center;">
                            <a href="{{route('track-order.result',['order_id'=>$order->id,'phone_number'=>$user_phone])}}" style="background-color: #1a82e2; padding:15px 20px;border:none;
            ...
            <h4 style="text-align: center;padding: 15px 0;line-height: 1.5;" >
