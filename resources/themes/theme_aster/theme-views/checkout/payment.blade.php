...
@section('content')
    ...
    <main class="main-content d-flex flex-column gap-3 py-3 mb-5">
        <div class="container">
            <h4 class="mb-3 fs-30">{{ translate('Payment_Details') }}</h4>

            <div class="row">
                <div class="col-lg-8 mb-3 mb-lg-0">
                    <div class="card h-100">
                        <div class="card-body  px-sm-4 text-center">
                            ...
                            <h4 class="my-5">{{ translate('Payment_Information') }}</h4>
                                ...
                                <ul class="option-select-btn flex-wrap gap-3">
                                    ...
                                    <li>
                                        <form action="{{route('checkout-complete')}}" method="get">
                                            <label>
                                                ...
                                                <button type="submit" class="payment-method py-5 payment-card-height dashed-border d-flex align-iems-center gap-3 overflow-hidden">
                                    ...
                                    @if ($digital_payment['status']==1)
                                        @if(auth('customer')->check() && $wallet_status==1)
                                            <li>
                                                <label class="">
                                                    <button class="payment-method py-5 payment-card-height dashed-border d-flex align-iems-center gap-3 overflow-hidden" type="submit" data-bs-toggle="modal" data-bs-target="#wallet_submit_button">
                                        ...
                                        @foreach ($payment_gateways_list as $payment_gateway)
                                            <li>
                                                <form method="post" class="digital_payment" action="{{ route('customer.web-payment-request') }}">
                                                    @csrf
                                                    ...
                                                    <label>
                                                        ...
                                                        <button class="payment-method payment-card-height dashed-border py-5 d-flex align-iems-center gap-3 digital-payment-card overflow-hidden" type="submit">
                                                            <img width="130" src="{{asset('storage/app/public/payment_modules/gateway_image')}}/{{$additional_data != null ? $additional_data->gateway_image : ''}}"
                                            ...
                                            <form action="{{route('offline-payment-checkout-complete')}}" method="get" class="digital_payment d--none">
                                                <label>
                                                    ...
                                                    <span class="payment-method d-flex align-iems-center gap-3 overflow-hidden" data-bs-toggle="modal" data-bs-target="#offline_payment_submit_button">
                                                        <img width="130" src="{{ theme_asset('assets/img/payment/pay-offline.png') }}" class="dark-support" alt="">
                                                    </span>
                                                </label>
                                            </form>
                                        </li>
