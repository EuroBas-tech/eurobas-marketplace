                ...
                <ul class="list-unstyled list-separator mb-0">
                    ...
                    @else
                        <li class="login-register d-flex gap-4">
                            <a href="{{ route('customer.auth.login') }}" class="media gap-2 align-items-center fs-14 bg-transparent border-0 p-0">
                        ...
                        <li class="d-none d-xl-block">
                            <a href="{{route('customer.auth.sign-up-type')}}" class="media gap-2 align-items-center fs-14 bg-transparent border-0 p-0">
