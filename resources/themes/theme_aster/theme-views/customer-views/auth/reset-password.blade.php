...
@section('title', translate('Reset_Password').' | '.$web_config['name']->value)
...
<style>
    ...
    .input-inner-end-ele { position: relative; }
    .input-inner-end-ele .form-control { padding-right: 44px; }
    ...
    <div class="container">
        <div class="row g-0 shadow-lg" style="border-radius:20px;overflow:hidden;max-width:900px;margin:0 auto;">
            ...
            <div class="col-lg-7 auth-right">
                <div class="lock-icon">
                    <i class="bi bi-shield-lock" style="font-size:24px;color:#3b82f6;"></i>
                </div>
                ...
                <form action="{{ request('customer.auth.password-recovery') }}" class="reset-password-form" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-inner-end-ele">
                            <input type="password" id="password2" name="password" class="form-control" placeholder="{{ translate('minimum_8_characters_long') }}" required>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-inner-end-ele">
                            <input type="password" id="confirm_password2" class="form-control" name="confirm_password" placeholder="{{ translate('minimum_8_characters_long') }}" required>
                            <i class="bi bi-eye-slash-fill togglePassword"></i>
                        </div>
                    </div>
