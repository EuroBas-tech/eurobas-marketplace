                                                ...
                                                <div class="">
                                                    ...
                                                    @if (count(json_decode($product->colors)) > 0)
                                                        <div class="d-flex gap-4 flex-wrap align-items-center mb-3">
                                                            ...
                                                            <ul style="max-width: 175px;" class="option-select-btn custom_01_option flex-wrap weight-style--two gap-2 pt-2">
                                                    ...
                                                    @foreach (json_decode($product->choice_options) as $key => $choice)
                                                        <div class="d-flex gap-4 flex-wrap align-items-center mb-4">
                                                            ...
                                                            <ul style="max-width: 200px;" class="option-select-btn custom_01_option flex-wrap weight-style--two gap-2">
