<div class="col-xxl-10 col-xl-9 col-lg-9 col-md-12 px-3"> 
    <div> 
        <form id="ads-store-form" method="POST" action="{{route('store.sponsor')}}" enctype="multipart/form-data"> 
            @csrf 
            <input type="hidden" name="type" value="{{$sponsor_type}}">
            <div class="col-xl-12 mb-4"> 
                <div class="form-group"> 
                    <h1 class="pt-4 pb-3 sponsor-title">{{translate('Show on your ads urgent sale sticker')}}</h1> 
                </div> 
            </div>
