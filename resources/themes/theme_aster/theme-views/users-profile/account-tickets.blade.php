    ...
    <main class="main-content d-flex flex-column gap-3 py-3 mb-4">
        <div class="container">
            <div class="row g-4">
                ...
                <div class="col">
                    <div class="card h-100 card-border aside-shadow">
                                            ...
                                            <div class="media-body">
                                                <div class="d-flex flex-column gap-1">
                                                    <div class="media align-items-start justify-content-between">
                                                        <div class="media-body">
                                                            <h6 class="mb-2">{{ \App\CPU\customer_info()->name }}</h6>
                                                        ...
                                                        <div class="d-flex align-items-center gap-2" >
                                                            ...
                                                            @endif
                                                            <a href="{{route('support-ticket.index',$supportTicket['id'])}}" class="btn btn-outline-primary fw-semibold text-nowrap">{{ translate('view') }}</a>
                                                        </div>
                                                    </div>
