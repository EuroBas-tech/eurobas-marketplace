    ...
    <script>
        ...
        function get_phone_number(phone_number, element) {
            ...
            navigator.clipboard.writeText(phone_number).then(() => {
                toastr.success('{{translate("Phone number copied to clipboard")}}!');
                ...
                toastr.error('{{translate("Failed to copy phone number")}}.');
            });
        }
        ...
        function get_email_address(email_address, element) {
            ...
            navigator.clipboard.writeText(email_address).then(() => {
                toastr.success('{{translate("Email Address copied to clipboard")}}!');
                ...
                toastr.error('{{translate("Failed to copy email address")}}.');
            });
        }
