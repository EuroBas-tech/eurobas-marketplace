                ...
                <div class="col">
                    <div class="card h-100">
                        <div class="card-body p-lg-4">
                            ...
                            <div class="mt-4">
                                <div class="table-responsive d-none d-sm-block rounded dashed-border">
                                    <table class="table align-middle table-striped rounded">
                                        <thead class="bg-cool-blue" >
                                        <tr>
                                            <th>{{translate('SL')}}</th>
                                        ...
                                        <tr>
                                                ...
                                                <div class="media gap-3 align-items-center mn-w200">
                                                    <div class="avatar rounded" style="--size: 3.75rem">
                                                        ...
                                                        <img onerror="this.src='{{ theme_asset('assets/img/image-place-holder.png') }}'"
                                                            src="{{ cloudfront('shop/'.$order->seller->shop->image)}}" class="img-fit dark-support rounded" alt="">
                                                    ...
                                                    <div class="media-body">
                                                        ...
                                                        <div class="text-dark fs-12 py-1">{{count($order->details)}} {{translate('items')}}</div>
                                                        <p class="text-muted fs-12">{{date('d M, Y h:i A',strtotime($order['created_at']))}} ({{$order['created_at']->diffForHumans()}})</p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="text-center">
                                                ...
                                                <div class="{{ $order['payment_status']=='unpaid' ? 'text-danger':'text-success' }} mt-1 fw-bold"> {{ translate($order['payment_status']) }}</div>
                                            </td>
                                                    ...
                                                    <a href="{{route('generate-invoice',[$order->id])}}" class="btn btn-outline-success btn-action">
                                                        ...
                                                        @if($order['order_status']=='pending')
                                                            <a href="javascript:" title="{{ translate('Cancel') }}"
                                                                onclick="route_alert('{{ route('order-cancel',[$order->id]) }}', `{{ translate('want_to_cancel_this_order?') }} , {{ translate('note_that_the_transaction_fees_will_be_deducted_after_your_refund') }}`)"
                                    ...
                                    @if($orders->count()==0)
                                        <div class="mb-5 mt-5 text-center">{{ translate('order_not_found') }} !</div>
                                    @endif
