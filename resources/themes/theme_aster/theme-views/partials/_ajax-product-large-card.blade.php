...
<style>
    /* Blue color for all SVG/Bootstrap icons in card */
    .product-card-icon { color: #3b82f6; }
    .torn-paper-sticker {
                        ...
                        <div class="text-start" >
                            @if($ad->category->category_type == 'vehicles' && $ad->category->slug != 'bicycles')
                                <div class="mb-1 d-flex align-items-center gap-3" style="font-size: 15px;" >
                                    ...
                                    @if($ad->year)
                                        <span class="d-flex align-items-center gap-1" >
                                            <span><span><i class="bi bi-calendar-event" style="color:#3b82f6"></i></span></span>
                                            <span>{{ $ad->year }}</span>
                                        </span>
                                    @endif
                                </div>
