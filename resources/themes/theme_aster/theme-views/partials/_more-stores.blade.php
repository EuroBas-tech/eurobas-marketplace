    ...
    <div class="container">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between gap-3">
                                        @foreach($order['details']->take(3) as $key=>$detail)
                                            <div>
                                                ...
                                                alt="" class="dark-support rounded-circle-cat">
                                            </div>
                                        @endforeach
        ...
        @else
            ...
            {{-- <div class="d-sm-none mb-4">
                ...
                @else
                    <img src="{{ theme_asset('assets/img/top-side-banner-placeholder.png') }}" loading="lazy" class="dark-support rounded w-100">
                @endif
            </div> --}}
        @endif
        <!-- for mobile end -->
        ...
        <div class="pb-3">
            <div class="">
                <div class="d-flex flex-wrap justify-content-between gap-3 mb-4">
                    ...
                    <a href="{{route('sellers')}}" class="outlined-bordered-btn">{{translate('view_all')}}<i
                                    ...
                                    <div class="position-relative">
                                        <div class="avatar rounded-circle">
                                            <img onerror="this.src='{{ theme_asset('assets/img/image-place-holder.png') }}'"
                                                src="{{ cloudfront('shop/'.$seller->shop->image)}}" alt="" loading="lazy"
                                                class="dark-support img-fit rounded-circle-cat responsive-profile-image">
                                        </div>
