    ...
    @if(!empty($ads))
        @foreach($ads as $ad)
            <li class="list-group-item p-2">
                <a class="font-size-16 d-flex align-items-center gap-2" href="{{ app()->getLocale() === config('laravellocalization.defaultLocale', 'en') ? route('ads-show', $ad->slug) : url(app()->getLocale() . '/ads/show/' . $ad->slug) }}">
                    <div>
