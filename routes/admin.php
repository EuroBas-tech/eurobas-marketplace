...
Route::group(['namespace' => 'Admin', 'prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin']], function () {
        ...
        Route::get('/get-refund-requests', 'SystemController@get_refund_requests')->name('get-refund-requests');
        ...
        Route::group(['prefix' => 'subscription', 'as' => 'subscription.'], function () {
            ...
            Route::get('view/{id}', 'SubscriptionController@view')->name('view');
            // Route::get('update/{id}', 'SubscriptionController@edit')->name('update');
            // Route::post('update/{id}', 'SubscriptionController@update');
            Route::post('status', 'SubscriptionController@status')->name('status');

            Route::group(['prefix' => 'promotional-videos', 'as' => 'promotional-videos.'], function () {
                Route::get('list', 'SubscriptionController@promotional_videos')->name('list');
                Route::post('status-update', 'SubscriptionController@status_update')->name('status-update');
                Route::post('delete', 'SubscriptionController@delete_promotional_video')->name('delete');
            });

            Route::get('settings', 'SubscriptionController@settings')
            ->name('subscription-settings');

            Route::post('settings', 'SubscriptionController@store_settings')
            ->name('store-subscription-settings');

            Route::post('subscription-type-status', 'SubscriptionController@subscription_type_status')
            ->name('subscription-type-status');
            
            Route::group(['prefix' => 'packages', 'as' => 'packages.'], function () {
                Route::get('add-new', 'SubscriptionPackageController@add_new')->name('add-new');
                Route::post('add-new', 'SubscriptionPackageController@store')->name('store');
                Route::get('list', 'SubscriptionPackageController@list')->name('list');
                Route::get('export', 'SubscriptionPackageController@export')->name('export');
                Route::get('view/{id}', 'SubscriptionPackageController@view')->name('view');
                Route::get('edit/{id}', 'SubscriptionPackageController@edit')->name('edit');
                Route::get('features-view/{id}', 'SubscriptionPackageController@features_view')->name('add-remove-features');
                
                Route::post('update', 'SubscriptionPackageController@update')->name('update');
                Route::post('status-update', 'SubscriptionPackageController@status_update')->name('status-update');
                Route::post('features', 'SubscriptionPackageController@features')->name('store-remove-features');
                Route::post('delete', 'SubscriptionPackageController@delete')->name('delete');

            });

        });

        Route::group(['prefix' => 'category-type', 'as' => 'category-type.','middleware'=>['module:product_management']], function () {
            Route::get('view', 'CategoryTypeController@index')->name('view');
            Route::get('fetch', 'CategoryTypeController@fetch')->name('fetch');
            Route::post('store', 'CategoryTypeController@store')->name('store');
            Route::get('edit/{id}', 'CategoryTypeController@edit')->name('edit');
            Route::post('update/{id}', 'CategoryTypeController@update')->name('update');
            Route::post('delete', 'CategoryTypeController@delete')->name('delete');
            Route::post('status', 'CategoryTypeController@status')->name('status');
        });
        ...
        Route::group(['prefix' => 'ad', 'as' => 'ad.','middleware'=>['module:product_management']], function () {
            Route::get('list', 'AdController@list')->name('list');
            Route::get('view/{id}', 'AdController@view')->name('view');
            Route::get('fetch', 'AdController@fetch')->name('fetch');
            Route::post('status-update', 'AdController@status_update')->name('status-update');
            Route::get('export', 'AdController@export')->name('export');
            Route::delete('delete/{id}', 'AdController@delete')->name('delete');
        });
        
        Route::group(['prefix' => 'paid-banner', 'as' => 'paid-banner.','middleware'=>['module:product_management']], function () {
            Route::get('list', 'PaidBannerController@list')->name('list');
            Route::get('view/{id}', 'PaidBannerController@view')->name('view');
            Route::get('fetch', 'PaidBannerController@fetch')->name('fetch');
            Route::post('status-update', 'PaidBannerController@status_update')->name('status-update');
            Route::get('export', 'PaidBannerController@export')->name('export');
            Route::delete('delete/{id}', 'PaidBannerController@delete')->name('delete');
        });
        ...
        Route::group(['prefix' => 'model', 'as' => 'model.','middleware'=>['module:product_management']], function () {
            Route::get('add-new', 'ModelController@add_new')->name('add-new');
            Route::post('add-new', 'ModelController@store');
            Route::get('list', 'ModelController@list')->name('list');
            Route::get('update/{id}', 'ModelController@edit')->name('update');
            Route::post('update/{id}', 'ModelController@update');
            Route::post('delete', 'ModelController@delete')->name('delete');
            Route::get('export', 'ModelController@export')->name('export');
            Route::post('status-update', 'ModelController@status_update')->name('status-update');
        });
        
        Route::group(['prefix' => 'report', 'as' => 'report.','middleware'=>['module:product_management']], function () {
            Route::get('list', 'ReportController@list')->name('list');
            Route::get('view/{id}', 'ReportController@view')->name('view');
            Route::delete('delete', 'ReportController@delete')->name('delete');
        ...
        Route::group(['prefix' => 'list', 'as' => 'list.','middleware'=>['module:product_management']], function () {
            ...
            Route::get('list/{type}', 'ListController@list')->name('list');
            Route::get('update/{id}', 'ListController@edit')->name('update');
        ...
        Route::group(['prefix' => 'refund-section', 'as' => 'refund-section.','middleware'=>['module:order_management']], function () {
            ...
            Route::group(['prefix' => 'refund', 'as' => 'refund.'], function () {
                ...
                Route::get('complete/{id}', 'RefundController@complete')->name('complete');
        ...
        Route::group(['prefix' => 'accounting', 'as' => 'accounting.'], function () {
            ...
            Route::post('update-costs-and-expenses', 'AccountingController@update_costs')->name('update-costs-and-expenses');
            Route::post('delete-costs-and-expenses', 'AccountingController@delete_costs')->name('delete-costs-and-expenses');
            Route::post('pdf-costs-and-expenses', 'AccountingController@pdf_costs_and_expenses')->name('pdf-costs-and-expenses');            
            Route::get('cost-summary-pdf', 'AccountingController@cost_summary_pdf')->name('cost-summary-pdf');
            Route::get('cost-export-excel', 'AccountingController@cost_export_excel')->name('cost-export-excel');
            Route::get('admin-earning-excel-export', 'AccountingController@admin_earning_excel_export')->name('admin-earning-excel-export');
        ...
        Route::get('seller-reports', 'TransactionReportController@seller_report')->name('seller-reports');
        ...
        Route::group(['prefix' => 'business-settings', 'as' => 'business-settings.'], function () {
            ...
            Route::group(['prefix' => 'video-api', 'as' => 'video-api.','middleware'=>['module:system_settings']], function () {
                Route::get('/', 'VideoApiController@index')->name('index')->middleware('actch');
                Route::post('/update', 'VideoApiController@update')->name('update');
            });
        ...
        Route::group(['prefix' => 'orders', 'as' => 'orders.','middleware'=>['module:order_management']], function () {
            ...
            Route::get('generate-shipping/{id}', 'OrderController@generate_shipping')->name('generate-shipping')->withoutMiddleware(['module:order_management']);
        ...
        Route::group(['prefix' => 'seller-help-topic', 'as' => 'seller-help-topic.','middleware'=>['module:system_settings']], function () {
            Route::get('list', 'SellerHelpTopicController@list')->name('list');
            Route::post('add-new', 'SellerHelpTopicController@store')->name('add-new');
            Route::get('status/{id}', 'SellerHelpTopicController@status')->name('status');
            Route::get('edit/{id}', 'SellerHelpTopicController@edit');
            Route::post('update/{id}', 'SellerHelpTopicController@update');
            Route::post('delete', 'SellerHelpTopicController@destroy')->name('delete');
        });
