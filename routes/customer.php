...
Route::group(
    [
        ...
        'middleware' => [
            'localize',                 // Set locale
            'localizationRedirect',     // Redirect missing locale
            'localeViewPath'            // Load localized views
        ]
    ],
    function () {
        ...
        Route::group(['namespace' => 'Customer', 'prefix' => 'customer', 'as' => 'customer.'], function () {
            ...
            Route::group(['namespace' => 'Auth', 'prefix' => 'auth', 'as' => 'auth.'], function () {
                ...
                Route::get('sign-up-type', 'RegisterController@register_type')->name('sign-up-type');

                Route::withoutMiddleware([\App\Http\Middleware\VerifyCsrfToken::class])
                    ->match(['get', 'post'], 'sign-up', 'RegisterController@register')
                    ->name('sign-up');

                Route::post('register-store', 'RegisterController@submit')->name('register-store');
