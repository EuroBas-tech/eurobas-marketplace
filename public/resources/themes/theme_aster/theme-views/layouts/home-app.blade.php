...
<head>
    ...
    <!-- ======= MAIN STYLES ======= -->
    <link rel="stylesheet" href="{{ theme_asset('assets/css/style.css?v=1234804563') }}"/>
    ...
    <!-- ======= CUSTOMIZE STYLES ======= -->
    <link rel="stylesheet" href="{{ theme_asset('assets/css/custom.css?v=14725896300') }}"/>
...
<script src="{{ theme_asset('assets/js/main.js?v=123486310564') }}"></script>
<script src="{{ theme_asset('assets/js/custom.js?v=2345315643') }}"></script>
...
<script>
    $(document).ready(function () {
        ...
        $categorySelect.on('change', function () {
            $brandSelect.val(null).trigger('change'); // reset brand when category changes
            $modelSelect.val(null).trigger('change');
            filterModels();
        });
        ...
        $('#color').on('select2:open', function () {
            setTimeout(function () {
                $('.select2-results__option').each(function () {
                    ...
                    // Avoid adding the square multiple times
        ...
        $('#color').on('change', function () {
            setTimeout(function () {
                // Find the correct selection display for #color
                const $selection = $('#color').next('.select2-container').find('.select2-selection__rendered');

                // Clear any previous square (if exists)
