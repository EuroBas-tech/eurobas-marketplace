...
<head>
    ...
    <!-- ======= MAIN STYLES ======= -->
    <link rel="stylesheet" href="{{ theme_asset('assets/css/style.css?v=123453148645564') }}"/>
...
<script src="{{ theme_asset('assets/js/main.js?v=1235') }}"></script>
<script src="{{ theme_asset('assets/js/custom.js?v=2345467206543') }}"></script>
