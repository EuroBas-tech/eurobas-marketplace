                    ...
                    <div class="widget widget--about text-center text-lg-start absolute-white">
                        ...
                        <form class="newsletter-form" action="{{ route('subscription') }}" method="post">
                            ...
                            <div class="position-relative">
                                ...
                                <button type="submit" class="btn primary-blue-bg-color orange-bg-color-hover">{{ translate('submit') }}</button>
                            </div>
                        </form>

                        <ul class="list-socials list-socials--white gap-4 pt-4 pb-2 fs-18">
