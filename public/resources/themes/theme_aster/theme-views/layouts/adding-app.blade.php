...
<head>
    ...
    <!-- ======= MAIN STYLES ======= -->
    <link rel="stylesheet" href="{{ theme_asset('assets/css/style.css?v=123543112') }}"/>
...
<script src="{{ theme_asset('assets/js/custom.js?v=2345406542312') }}"></script>
...
<script>
    $(document).ready(function () {
        ...
        $brandSelect.on('change', function () {
            filterModels();
            $('#model-box').css('visibility', 'visible');
        ...
        $categorySelect.on('change', function () {
            ...
            if(selectedOption.attr('data-is-vehicle') == 1) {
                $('#brand-box').css('visibility', 'visible');
            } else {
                $('#brand-box').css('visibility', 'hidden');
                $('#model-box').css('visibility', 'hidden');
            }
            filterModels();
            addPersistentOptions();
        });
