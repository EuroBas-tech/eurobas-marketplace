                ...
                <div class="card mb-3">
                    <div class="card-body">
                        <div class="row gy-2 align-items-center">
                            <div class="col-lg-4">
                                <h3 class="mb-1 fs-30">{{translate(str_replace(['-', '_', '/'],' ',$data['data_from']))}} {{translate('products')}}</h3>
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb fs-12 mb-0">
                                      <li class="breadcrumb-item text-secondary"><a href="#">{{ translate('home') }}</a></li>
                                      <li class="breadcrumb-item text-secondary active" aria-current="page">{{translate(str_replace(['-', '_', '/'],' ',$data['data_from']))}} {{translate('products')}} {{ isset($data['brand_name']) ? ' / '.$data['brand_name'] : ''}} {{ request('name') ? '('.request('name').')' : ''}}</li>
                                    </ol>
                                  </nav>
                            </div>
                            <div class="col-lg-8">
                ...
                <div class="flexible-grid lg-down-1 gap-3" style="--width: 16rem">
                        ...
                        <div class="card-body d-flex flex-column gap-4">
                            ...
                            <div>
                                ...
                                <div class="products_aside_categories">
                                    <ul class="common-nav flex-column large-padding-bottom nav custom-scrollbar flex-nowrap custom_common_nav">
                    ...
                    <div class="">
                        ...
                        <div class="d-flex flex-wrap flex-lg-nowrap align-items-start justify-content-between gap-3 mb-2">
                              <h2>@if(isset($data['brand_name']))
                                "{{ $data['brand_name'] }}"
                            @endif</h2>
                            <div class="flex-middle gap-3"></div>
                            <div class="d-flex align-items-center mb-3 mb-md-0 pb-2 flex-wrap flex-md-nowrap gap-3">
                                ...
                                @if(count(\App\Model\Category::where('parent_id', $data['id'])->get()))
                                <div class="card cat-card my-3">
                                @foreach(\App\Model\Category::where('parent_id', $data['id'])->get() as $child)
                                    <a  href={{route('products',['id'=> $child['id'],'data_from'=>'category','page'=>1])}}>
                                        @if($child->icon)
                                            <img class="cat-image cat-box" width="130" onerror="this.src='{{ theme_asset('assets/img/image-place-holder.png') }}'"
                                                 src="https://dev.eurobas.de/storage/app/public/product/2023-11-10-654e902c22d7f.webp"
                                                 loading="lazy" class="dark-support rounded text-center">


                                            <h6 class="text-center cat-title-size ">{{ $child->name }}</h6>
                                            @else
                                            <h6 class="cat-title ">{{ $child->name }}</h6>
