       ...
       class="store-product d-flex flex-column gap-2 align-items-center">
        <div class="store-product__top border rounded mb-2">
            ...
            <img width="155"
                 ...
                 loading="lazy" class="dark-support rounded prod-imag4">
        </div>
        <a class="text-capitalize font-size-11-mobile" href="{{route('product',$product->slug)}}" style="--width: 9rem">
            ...
            <div class="product__price d-flex justify-content-center align-items-center flex-wrap column-gap-2 mt-1">
                @if($product->discount > 0)
                    <del class="product__old-price font-size-13-mobile currency-font">
                        {{\App\CPU\Helpers::currency_converter($product->unit_price)}}
                    </del>
                @endif
                <ins class="product__new-price font-size-13-mobile currency-font">
