...
<div class="product border rounded product-card-shadow scale-image-hover-effect text-center d-flex flex-column gap-10" onclick="location.href='{{route('product',$product->slug)}}'">
    <!-- Product top -->
    <div class="product__top" style="--width: 100%; --height: 12.5rem">
        ...
        <div class="product__thumbnail">
            <img style="height: 188px;" src="{{\App\CPU\ProductManager::product_image_path('thumbnail')}}/{{$product['thumbnail']}}"
        ...
        <div class="d-flex align-items-center w-100 justify-content-between" >
            <div class="text-muted fs-12">
                @if($product->added_by=='seller')
                    {{ isset($product->seller->shop->name) ? \Illuminate\Support\Str::limit($product->seller->shop->name, 8) : '' }}
