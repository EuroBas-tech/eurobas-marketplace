...
class ProfileController extends Controller
{
    public function view()
    {
        ...
        return view('seller-views.profile.view', compact('data', 'withdrawal_payment_methods'));
    }
    ...
    public function bank_update(Request $request, $id)
    {
        ...
        $bank->swift = !empty($request->swift) ? $request->swift : null;
        $bank->payment_country = $request->payment_country;
    ...
    public function update_default_payment_method(Request $request, $id) {
        $seller = Seller::find(auth('seller')->id());

        $seller->default_payment_method = $request->default_payment_method;
        $seller->save();

        Toastr::success(translate('default_payment_method_updated'));
