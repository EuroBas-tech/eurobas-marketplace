...
class EmployeeController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if (!empty($request->file('identity_image'))) {
            foreach ($request->identity_image as $img) {
                array_push($identity_images, ImageManager::upload('admin/', 'webp', $img, 'def.jpg'));
            }
        ...
        DB::table('admins')->insert([
            ...
            'status'=>1,
            'image' => ImageManager::upload('admin/', 'webp', $request->file('image'), 'def.jpg'),
            'created_at' => now(),
            'updated_at' => now(),
        ]);
    ...
    public function update(Request $request, $id)
    {
        ...
        if (!empty($request->file('identity_image'))) {
            ...
            $img_keeper = [];
            foreach ($request->identity_image as $img) {
                array_push($img_keeper, ImageManager::upload('admin/', 'webp', $img, 'def.jpg'));
            }
