...
class PaymentMethodController extends Controller
{
    ...
    public function payment_config_set(Request $request)
    {
        ...
        elseif ($request['gateway'] == 'ssl_commerz') {
            $additional_data = [
                'status' => 'required|in:1,0',
                'store_id' => 'required',
        ...
        $additional_data_image = $settings['additional_data'] != null ? $settings['additional_data'] : null;
        ...
        Setting::updateOrCreate(['key_name' => $request['gateway'], 'settings_type' => 'payment_config'], [
            ...
            'additional_data' => $payment_additional_data,
        ]);
