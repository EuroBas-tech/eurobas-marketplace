...
class ProductController extends BaseController
{
    ...
    public function store(Request $request)
    {
        ...
        {
            $p->shipping_country = json_encode($request->countries);
        }
        else
        $p->shipping_country="All";
            $p->save();
    ...
    public function edit($id)
    {
        ...
        $brand_setting = BusinessSetting::where('type', 'product_brand')->first()->value;
        $digital_product_setting = BusinessSetting::where('type', 'digital_product')->first()->value;
        return view('admin-views.product.edit', compact('categories', 'br', 'product', 'product_category','brand_setting','digital_product_setting','shipping_country'));
    }
