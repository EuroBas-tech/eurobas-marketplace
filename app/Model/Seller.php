...
class Seller extends Authenticatable
{
    ...
    public function sellerBalanceTransaction() {
        return $this->hasMany(SellerBalanceTransaction::class);
    }

    public function withdrawMethod() {
        return $this->belongsTo(WithdrawalMethod::class, 'default_payment_method');
    }

    public function payoutHistory(){
        return $this->hasMany(SellerPayoutHistory::class);
    }
